...
$(document).on('click', '.edit-btn', function () {
   ...
   $.ajax({
    url: baseUrl + 'suppliers/edit/' + UserId,
    method: 'GET',
    dataType: 'json',
    success: function (response) {
        if (response.data) {
            $('#editUserModal #supplier_name').val(response.data.supplier_name);
            $('#editUserModal #supplier_id').val(response.data.supplier_id);
            $('#editUserModal #contact_number').val(response.data.contact_number);
...
$(document).on('click', '.deleteUserBtn', function () {
    ...
    if (confirm('Are you sure you want to delete this supplier?')) {
        $.ajax({
            url: baseUrl + 'suppliers/delete/' + UserId,
            method: 'POST', 
            data: {
                _method: 'DELETE',
                [csrfName]: csrfToken
